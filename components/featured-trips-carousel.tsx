...
const featuredTrips = [
  ...
  },
  {
    ...
    description: "UNESCO World Heritage site with ancient temples and ruins",
    highlights: ["Virupaksha Temple", "Stone Chariot", "Hampi Bazaar", "Sunset Point"],
    category: "Heritage",
  },
  {
    id: 4,
    title: "Chikmagalur Coffee Land",
    slug: "chikmagalur-coffee-land",
