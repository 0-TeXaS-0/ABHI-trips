...
export const trips: Trip[] = [
  ...
  },
  {
    ...
    itinerary: [
      ...
      { time: "Day 1 - 06:00 AM", activity: "Arrival, check-in, freshen up, and breakfast" },
      { time: "09:30 AM", activity: "Visit Mandalpatti View Point (optional jeep ride)" },
      { time: "01:00 PM", activity: "Lunch break (self-sponsored)" },
      { time: "02:00 PM", activity: "Explore Kote Abbey Falls" },
      { time: "03:45 PM", activity: "Visit Raja Seat and soak in the sunset" },
      { time: "06:30 PM", activity: "Visit the Omkareshwar Temple" },
      { time: "07:30 PM", activity: "Return to stay, Campfire & Dinner" },
      { time: "Day 2 - 10:00 AM", activity: "Breakfast and head to Harangi Elephant Camp" },
      { time: "11:00 AM", activity: "Elephant interaction (optional activities)" },
      { time: "12:30 PM", activity: "Lunch break (self-sponsored)" },
      { time: "02:00 PM", activity: "Explore Namdroling Monastery" },
  ...
  },
  {
    ...
    highlights: [
      "Virgin beaches of Gokarna - Paradise Beach, Half Moon Beach",
      "Majestic Murudeshwar Temple with world's 2nd tallest Shiva statue",
      "Beach trekking and water sports activities",
      "Stunning coastal sunset and sunrise views",
      "Authentic coastal cuisine experience"
    ],
  ...
  },
  {
    ...
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/chikmagalur-PJjxJ6OpiWIbc3vY2OqhbxaYFsBmy5.jpeg",
    price: "₹3,799",
    originalPrice: "₹4,299",
    duration: "2 Days / 1 Night",
    difficulty: "Easy",
    ...
    category: "Two Day Trip",
    fullDescription:
      "Discover the enchanting hill station of Chikmagalur, known as the coffee capital of India. This 2-day journey takes you through aromatic coffee plantations, misty mountains, cascading waterfalls, and offers a perfect escape into nature's embrace.\n\nNestled in the Western Ghats, Chikmagalur is famous for its coffee estates, rolling hills, and pleasant climate throughout the year. As the birthplace of coffee cultivation in India, the region offers a unique blend of adventure, nature, and cultural experiences. From climbing Karnataka's highest peak to exploring the origins of Indian coffee, this trip provides the perfect weekend getaway from Bangalore.",    
    itinerary: [
      { time: "Day 0 - 10:00 PM", activity: "Begin Your Scenic Journey to the Chikmagalur" },
      { time: "Day 1 - 06:00 AM", activity: "Arrive at Chikmagalur and head to Mullayanagiri Peak" },
      { time: "09:00 AM", activity: "Check-in, freshen up, and breakfast" },
      { time: "10:00 AM", activity: "Visit Honnammana Halla Falls, Baba Budangiri, and Z Point" },
      { time: "02:00 PM", activity: "Lunch break" },
      { time: "04:00 PM", activity: "Visit Hirekolale Lake for sunset" },
      { time: "06:30 PM", activity: "Return to stay, campfire, and veg dinner" },
      { time: "Day 2 - 09:00 AM", activity: "Breakfast and checkout" },
      { time: "10:00 AM", activity: "Water sports at Yagachi Dam (self-sponsored)" },
      { time: "01:00 PM", activity: "Lunch en route to Belur" },
      { time: "02:00 PM", activity: "Visit Chennakeshava Temple, Belur" },
      { time: "03:00 PM", activity: "Explore Hoysaleshwara Temple, Halebeedu" },
    ...
    pickupPoints: [
      "10:00 PM - BMTC Bus Stop, Banashankari",
      "10:15 PM - Udupi Garden Signal, BTM Layout",
      "10:30 PM - Bus Stop, Silk Board",
      "10:45 PM - Koramangala",
      "11:00 PM - Domlur",
      "11:15 PM - MG Road",
      "11:30 PM - KTM Mekhri Circle",
      "11:45 PM - Yeshwanthpura",
      "12:00 AM - Goraguntepalya",
    ],
    inclusions: [
      "Non-A/C Transport from Bangalore (Round Trip)",
      "2 Breakfasts and 1 Dinner (Veg)",
    ...
    exclusions: [
      "Optional Activities (Water sports, etc.)",
      "Personal Expenses: Snacks, Bottled Water, Additional Meals",
      "Insurance of any kind",
      "Anything not listed in the \"Inclusions\""
    ],
