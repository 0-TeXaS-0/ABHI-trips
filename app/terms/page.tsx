...
import { FileText, Shield, CreditCard, Calendar, AlertTriangle, Users, Phone, MapPin, Sparkles } from "lucide-react"
...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      {/* Hero Section */}
      <section ref={heroRef} className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 text-white py-24 pt-32 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute inset-0 opacity-10">
            <svg className="absolute bottom-0 left-0 w-full h-48 md:h-56 lg:h-64 transform scale-110" viewBox="0 0 1440 320" preserveAspectRatio="none">
              <path 
        ...
        <div className="relative container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-6 animate-float">
              ...
              <Badge variant="outline" className="border-blue-400 text-blue-400 bg-blue-400/20 backdrop-blur-sm shadow-glow transition-all duration-300 hover:bg-blue-400/30">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed backdrop-blur-sm px-4 py-2 rounded-lg bg-blue-900/20">
              Please read these terms and conditions carefully before booking any adventure with Abhi Trip. 
              Your booking constitutes acceptance of these terms.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <Card className="border-0 shadow-2xl hover:shadow-3xl transition-all duration-300 bg-gradient-to-br from-white to-red-50">
              ...
              <CardContent className="space-y-4 text-gray-700 p-8">
                ...
                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-blue-800"><strong>Note:</strong> Refunds will be processed within 7-10 working days after cancellation.</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4 text-gray-700 p-8">
                <div className="grid gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <p>Abhi Trip reserves the right to modify itineraries due to weather conditions, natural disasters, or unforeseen circumstances.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
            ...
            <Card className="border-0 shadow-2xl hover:shadow-3xl transition-all duration-300 bg-gradient-to-br from-white to-indigo-50">
              ...
              <CardContent className="space-y-4 text-gray-700 p-8">
                <p className="mb-4">For any queries or clarifications regarding these terms and conditions, please contact us:</p>
                <div className="grid gap-4">
                  <div className="flex items-start gap-3">
