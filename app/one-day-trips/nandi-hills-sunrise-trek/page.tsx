...
export default function NandiHillsSunriseTrekPage() {
  const trip = {
    ...
    image:
      "/images/adventure-sports.jpeg", // Using a local image from public/images folder
    price: "₹799",
    originalPrice: "₹999",
    duration: "1 Day",
    difficulty: "Easy",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="relative h-[60vh] md:h-[70vh] overflow-hidden pt-16">
        <Image src={trip.image} alt={trip.title} fill className="object-cover" priority quality={90}
