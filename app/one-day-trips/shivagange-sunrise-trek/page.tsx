...
export default function ShivagangeSunriseTrekPage() {
  const trip = {
    id: 4,
    title: "Shivagange Sunrise Trek",
    description:
      "Ascend the sacred peak of Shivagange, known as 'Dakshina Kashi,' located just ~60 km from Bangalore.",
    image:
      "/images/13.jpeg", // Using a local image to avoid remote image issues
    price: "₹799",
    originalPrice: "₹999",
    duration: "1 Day",
    difficulty: "Moderate",
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="mt-4 text-sm text-gray-600 italic">Timings are approximate and may vary based on group pace and conditions.</p>
              </CardContent>
            </Card>
