        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-xl p-6 border border-gray-200 sticky top-20">
              <div className="mb-4">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Book Your Dandeli Adventure</h3>
                <div className="flex items-center">
                  ...
                  <span className="ml-2 bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-0.5 rounded-full">9% OFF</span>
                </div>
              ...
              <div className="mb-5">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start text-sm">
                    ...
                    <span>Any kind of insurance</span>
                  </li>
                  <li className="flex items-start text-sm">
                    <XCircle className="h-4 w-4 text-red-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Personal Expenses (snacks, mineral water, etc)</span>
                  </li>
                  <li className="flex items-start text-sm">
                    <XCircle className="h-4 w-4 text-red-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Anything not included above</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-800">Vikram D.</h4>
                  <div className="flex items-center">
                    {[...Array(5)].map((_, i) => (
