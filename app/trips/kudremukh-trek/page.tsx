        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-8">
              {/* Pricing Card */}
              <Card className="shadow-xl border-0 bg-gradient-to-br from-emerald-100 via-teal-50 to-white hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group">
                <CardHeader className="text-center">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    <span className="text-3xl font-bold text-emerald-700 drop-shadow">₹3,899</span>
                    <span className="text-lg text-gray-400 line-through">₹4,399</span>
                  </div>
                  <p className="text-sm text-gray-600">per person</p>
                  <div className="mt-2">
                    <span className="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full px-3 py-1 text-xs font-bold text-white shadow-md">
                      11% OFF
                    </span>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="mb-4 bg-gradient-to-r from-yellow-50 to-teal-50 p-4 rounded-lg border border-yellow-200 shadow-sm group-hover:shadow-md transition-all duration-300">
                  ...
                  <div className="rounded-xl bg-white/80 shadow-inner p-2 hover:shadow-lg transition-all duration-300">
                    <BookingForm tripTitle="Kudremukh Trek" tripPrice="₹3,899" />
                  </div>
                  {/* Contact Options */}
                  <div className="mt-6 pt-6 border-t border-dashed border-emerald-200 space-y-3">
                    <h4 className="font-medium text-center text-emerald-700">Need Help?</h4>
                    <div className="flex gap-2">
                      <a
                        href="tel:+919740174089"
                        className="flex-1 flex items-center justify-center gap-2 py-2 px-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors shadow-md hover:scale-105"
                      >
                      ...
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-2 py-2 px-4 bg-gradient-to-r from-green-500 to-green-700 text-white rounded-lg hover:from-green-600 hover:to-green-800 transition-colors shadow-md hover:scale-105"
                      >
              ...
              {/* Trip Details Card */}
              <Card className="shadow-lg border-0 bg-gradient-to-br from-teal-50 to-emerald-50 hover:shadow-xl hover:scale-[1.01] transition-all duration-300 group">
                <CardHeader>
                  <CardTitle className="text-lg text-emerald-800">Trip Details</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="flex items-center text-sm group-hover:text-emerald-700 transition-colors duration-300">
                    <Clock className="h-4 w-4 text-emerald-400 mr-2 group-hover:text-emerald-600 transition-colors duration-300" />
                    <span>2 Days / 1 Night</span>
                  </div>
                  <div className="flex items-center text-sm group-hover:text-emerald-700 transition-colors duration-300">
                    <Users className="h-4 w-4 text-emerald-400 mr-2 group-hover:text-emerald-600 transition-colors duration-300" />
                    <span>12-15 people per group</span>
                  </div>
                  <div className="flex items-center text-sm group-hover:text-emerald-700 transition-colors duration-300">
                    <MapPin className="h-4 w-4 text-emerald-400 mr-2 group-hover:text-emerald-600 transition-colors duration-300" />
                    <span>335km from Bangalore</span>
                  </div>
                  <div className="flex items-center text-sm group-hover:text-emerald-700 transition-colors duration-300">
                    <Star className="h-4 w-4 text-yellow-500 mr-2 group-hover:scale-110 transition-transform duration-300" />
                    <span>4.9/5 (83 reviews)</span>
                  </div>
                </CardContent>
              </Card>

              {/* Testimonial */}
              <div className="bg-gradient-to-br from-emerald-50 via-teal-50 to-white rounded-xl p-6 border border-emerald-100 shadow-lg hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 hover:border-teal-300 group relative overflow-hidden">
                <div className="absolute -top-8 -right-8 w-32 h-32 bg-gradient-to-br from-emerald-200/30 to-teal-200/20 rounded-full blur-2xl pointer-events-none"></div>
                <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-gradient-to-tr from-teal-200/30 to-emerald-200/20 rounded-full blur-xl pointer-events-none"></div>
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 group-hover:text-emerald-800 transition-colors duration-300">Rahul M.</h4>
                    <div className="flex items-center">
                      {[...Array(5)].map((_, i) => (
        ...
        <div className="my-10 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 border border-green-200 shadow-lg">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center bg-white rounded-lg p-3 border border-green-100 shadow-sm"><CheckCircle2 className="h-5 w-5 text-green-500 mr-2" />Kudremukh Trek with permits</li>
              <li className="flex items-center bg-white rounded-lg p-3 border border-green-100 shadow-sm"><CheckCircle2 className="h-5 w-5 text-green-500 mr-2" />Visit to tea/coffee estate</li>
